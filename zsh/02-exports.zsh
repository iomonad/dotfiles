...
export USER_CITY="Malmö, SE"
export USER_WEBSITE="https://inother.space/"
...
export USER_FAVORITE_PHILOSOPH="Noam Chomsky"
...
export ANDROID_PATHS="$ANDROID_BUILD_TOOLS:$ANDROID_PLATFORM_TOOLS"
# }}}
