...
alias -g     zshbm=$HOME/.config/zsh/02-bookmarks.zsh
alias -g   zshcmpl=$HOME/.config/zsh/02-completion.zsh
alias -g    zshexp=$HOME/.config/zsh/02-exports.zsh
alias -g    zshopt=$HOME/.config/zsh/02-setopts.zsh
alias -g   zshkeys=$HOME/.config/zsh/03-bindkeys.zsh
alias -g   zshfunc=$HOME/.config/zsh/03-functions.zsh
alias -g    zshgit=$HOME/.config/zsh/04-git.zsh
alias -g    zshapp=$HOME/.config/zsh/05-appearance.zsh
