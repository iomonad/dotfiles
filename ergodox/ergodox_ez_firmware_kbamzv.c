...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_EQUAL,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_CAPSLOCK,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,CTL_T(KC_Z),KC_X,KC_C,KC_V,KC_B,ALT_T(KC_NO),LT(1,KC_GRAVE),KC_QUOTE,KC_LALT,KC_LEFT,KC_RIGHT,KC_LPRN,KC_LCBR,KC_HOME,KC_SPACE,KC_LGUI,KC_END,KC_MINUS,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSPACE,TG(2),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,LT(2,KC_SCOLON),GUI_T(KC_ENTER),ALT_T(KC_NO),KC_N,KC_M,KC_COMMA,KC_DOT,CTL_T(KC_SLASH),KC_RSHIFT,KC_UP,KC_DOWN,KC_LBRACKET,KC_RBRACKET,KC_QUOTE,KC_RCBR,KC_RPRN,KC_PGUP,KC_PGDOWN,KC_TAB,KC_ENTER),
